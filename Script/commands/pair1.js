...
async function makeImage({ one, two }) {
    ...
    pairing_img.composite(circleOne.resize(150, 150), 100, 100).composite(circleTwo.resize(150, 150), 100, 100);
